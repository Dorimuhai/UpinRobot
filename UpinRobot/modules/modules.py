...
from UpinRobot import dispatcher, telethn
from UpinRobot.__main__ import (CHAT_SETTINGS, DATA_EXPORT, DATA_IMPORT,
                                   HELPABLE, IMPORTED, MIGRATEABLE, STATS,
                                   USER_INFO, USER_SETTINGS)
from UpinRobot.modules.helper_funcs.chat_status import dev_plus, sudo_plus
...
def listmodules(update: Update, context: CallbackContext):
    ...
    for helpable_module in HELPABLE:
        ...
        file_name = file_info.__name__.rsplit("UpinRobot.modules.", 1)[1]
